...
def generate_users_html():
  ...
  # Define file paths
  csv_path = r'C:\Users\CWilk\Desktop\PyhtonProj\data\azure_users.csv'
  output_html_path = r'C:\Users\CWilk\Desktop\PyhtonProj\public\users.html'
    ...
    <header>
      <div class="nav-container">
        <select class="nav-dropdown" onchange="location = this.value;">
          ...
          <option value="FrontEnd.html">Home</option>
        </select>
      </div>
